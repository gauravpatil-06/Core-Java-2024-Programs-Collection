...
class Reservation extends Flight
{
    void insertRecord()
    {
        ...
        flight_name = sc.next();
        System.out.print("Enter Flight Take Off place: ");
        Source = sc.next();
    ...
    void displayRecord()
    {
        ...
        System.out.println("Take Off place     : " + Source);
    ...
    void updateRecord()
    {
        ...
        flight_name = sc.next();
        System.out.print("Enter New Flight Take Off place: ");
        Source = sc.next();
        ...
        do
        {
            ...
            switch (choice)
            {
                ...
                case 4:
                    ...
                    if (i == N)
                    {
                        System.out.println("No such record for this flight number");
                    }
                    break;
                case 5:
                    ...
                    if (i == N)
                    {
                        System.out.println("Flight not found for booking!!!");
                    }
                    break;
                case 6:
