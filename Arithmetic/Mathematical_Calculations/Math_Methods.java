class Math_Methods
{
    public static void main(String args[])
    {
        ...
        System.out.println("exponential of 709.78222656 is " + Math.exp(709.78222656));
        System.out.println("round(200.675) = " + Math.round(200.675));
        System.out.println("round(200.50) = " + Math.round(200.50));
        System.out.println("round(200.20) = " + Math.round(200.20));
